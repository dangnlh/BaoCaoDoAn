...
<body>
    ...
    <header>
        ...
        <nav class="navbar navbar-expand-lg navbar-dark d-none d-lg-block" style="z-index: 2000;">
            <div class="container-fluid">
                <!-- Navbar brand -->
                <a class="navbar-brand nav-link" target="_blank" href="loginpage.html">
            ...
            <div class="mask d-flex align-items-center h-100" style="background-color: rgba(0, 0, 0, 0.8);">
                <div class="container">
                    <div class="row justify-content-center">
                        ...
                        <form:form method="POST" action="dang-ky" modelAttribute="account" class="bg-white  rounded-5 shadow-5-strong p-5">
                     			
                                <h1><center>Đăng kí tài khoản</center></h1>
                                ...
                                <div class="col text-center">
                                    <!-- Simple link -->
                                    <a href='<c:url value="/"></c:url>'>Bạn đã có tài khoản ?</a>
  ...
  <!--Footer-->
    <!-- MDB -->
     <script type="text/javascript" src='<c:url value="/assets/js/mdb.min.js"></c:url>'></script>


                <!-- Custom scripts -->
                <script type="text/javascript" src='<c:url value="/assets/js/script.js"></c:url>'></script>
